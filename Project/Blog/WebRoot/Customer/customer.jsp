...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	function check_all()
	{
		...
		{
			alert('提交失败,请核对信息');
			alert(cheack_birthday());
			alert(cheack_email());
			alert(cheack_password());
			alert(cheack_nick());
			alert(cheack_old_password());
				...
				<div class="item">
					...
					<div class="content-container">
						<div class="content contact-content">
							<div class="content-padding">
								<!-- Content Begin -->
								<form action="UserAction" onsubmit="check_all();" enctype="multipart/form-data"   method="post">
								<div class="grid_8" id="contact-form">
									<h2 class="border">Update Your All Message</h2>
									...
									<input  type="hidden" value="${user.u_Id}" name="id"/>
										<div class="rowElem">
											...
											<div class="field">
												<input type="text" onblur="cheack_nick();" onkeypress="cheack_nick();" name="actionuser.u_Nickname" id="u_Nickname" value="${user.u_Name}" />
											</div>
											<div id="error1">
										...
										<div class="rowElem">
											...
											<div class="field">	
												<input type="password" onblur="check_old_password();"  name="Password" id="Password" />
											</div>
											<div id="error4">
                                        ...
                                        <div class="rowElem">
											...
											<div class="field">	
												<input type="password" onblur="cheack_password();" onkeypress="cheack_password();" name="actionuser.u_Password" id="confPassword" />
											</div>
											<div id="error5">
										...
										<div class="rowElem" id="textarea">
											<label>Sign</label>
											<textarea  name="actionuser.u_Sign" rows="5" cols="25" id="message_input">${user.u_Sign}</textarea>
											<div class="error6">
										...
										<div id="submit">
											<label></label>
											<input type="submit"  value="Send" name="submitButton"  class="form-submit" />
										</div>
					...
					<li>	<img src="http://localhost:8080/Blog_SSH/${user.u_Pic}" style="width:206px; height:116px" ><input type="file" name="file" /></img></li>
										</ul>
