...
<div id="column-right">
  ...
  <div class="box-heading">账户</div>
   <div class="box-content">
       ...
       <li><a href="http://172.16.142.46:8080/ZH_2/Update_info?user=${user.user}&action=updateper">编辑账户</a></li>
      ...
      <li><a href="http://172.16.142.46:8080/ZH_2/control?showcar.jsp">我的购物车</a></li>
      </ul>
      </div>
</div>
  </div>
  <div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.46:8080/ZH_2">首页</a>
         &raquo; <a href="http://172.16.142.46:8080/ZH_2/edit_address.jsp?user=${user.user}">我的地址</a>
      </div>
  <h1>我的账户信息</h1>
  <form action="http://172.16.142.46:8080/ZH_2/Update_info?action=updateadd&user=${user.user}" method="post" >
    <h2>我的详细信息</h2>
    <div class="content">
      <table class="form">
        <tr>
          <td><span class="required">*</span> 详细地址：</td>
          <td><input type="text" name="address" value="${InfoBean.address}"/>
            </td>
        </tr>
        <tr>
          <td><span class="required">*</span> 城市：</td>
          <td><input type="text" name="city" value="${InfoBean.city}" />
            </td>
        </tr>
         <tr>
          <td><span class="required">*</span> 国家：</td>
          <td><select>
