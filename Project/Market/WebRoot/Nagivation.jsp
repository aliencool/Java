...
<div id="content">  <div class="breadcrumb">
       <a href="http://172.16.142.98:8080/ZH_2">首页</a>»<a href="http://172.16.142.98:8080/ZH_2/Nagivation.jsp?category=${param.category}">商品总导航(${param.category})</a>
      </div>
  <h1>欢迎来到商城</h1>
  <h2>简介</h2>
...
Welcome to BookShop</p>
  ...
  <div class="product-list">
  	<msg:Message_iteator  iteator='${Search_Info}' shopid="Info">
		  <div>
          <div class="image"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=nagivation&father=${param.category}"><img 
src="http://172.16.142.98:8080/ZH_2/${Info.getShop_Image()}" title="${Info.getShop_name()}" 
alt="MacBook" /></a></div>
            <div class="name"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=nagivation&father=${param.category}">${Info.getShop_name()}</a></div>
...
LP3065 Flat Panel ..</div>
    ...
    <div class="links">
   	<msg:MyCount id="cn">
   			<a href="http://172.16.142.98:8080/ZH_2/Category_control?action=category&page_count=${cn.getCount()}">第${cn.getCount()}页</a>
   	</msg:MyCount>
       </div></div>
  </div>
<div id="footer">
