...
Welcome to SuperMarkt</p>
  ...
  <div class="product-list">
	<msg:Message_iteator  iteator='${All_Info}' shopid="Info">
		  <div>
          <div class="image"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}"><img 
src="http://172.16.142.98:8080/ZH_2/${Info.getShop_Image()}" title="${Info.getShop_name()}" 
alt="MacBook" /></a></div>
            <div class="name"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}">${Info.getShop_name()}</a></div>
...
LP3065 Flat Panel ..</div>
    ...
    <div class="links">
   	<msg:MyCount id="cn">
   		<a href="http://172.16.142.98:8080/ZH_2/control?action=page&page_count=${cn.getCount()}">第${cn.getCount()}页</a>
   	</msg:MyCount>
       </div></div>
       </div>
<div id="footer">
