...
public class updateaddControlServlet extends Shop_cr{
	...
	public void SelectAll(HttpServletRequest req, HttpServletResponse resp)
	{
		...
		GotoUrl("Person_edit/edit_address.jsp",req,resp);
	...
	public void execute_shopcontrol(HttpSession Session,
		...
		SelectAll(request,response);
		GotoUrl("Person_edit/edit_address.jsp",request,response);
	}
