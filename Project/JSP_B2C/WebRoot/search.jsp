...
<div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.98:8080/ZH_2">首页</a>»<a href="http://172.16.142.98:8080/ZH_2/control?action=search_enter">搜索</a>
      </div>
  <h1>欢迎来到商城</h1>
  <h2>简介</h2>
...
Welcome to BookShop</p>
  ...
  <div class="product-list">
  	<msg:Message_iteator  iteator='${Search_Info}' shopid="Info">
		  <div>
          <div class="image"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=search"><img 
src="http://172.16.142.98:8080/ZH_2/${Info.getShop_Image()}" title="${Info.getShop_name()}" 
alt="MacBook" /></a></div>
            <div class="name"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=search">${Info.getShop_name()}</a></div>
...
LP3065 Flat Panel ..</div>
    ...
    <div class="links">
   	<msg:MyCount id="cn">
   		<a href="http://172.16.142.98:8080/ZH_2/control?action=page&page_count=${cn.getCount()}&search=value">第${cn.getCount()}页</a>
   	</msg:MyCount>
       </div></div>
  </div>
<div id="footer">
