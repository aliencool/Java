...
<div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.98:8080/ZH_2">首页</a>»<a href="http://172.16.142.98:8080/ZH_2/Nagivation_son.jsp?category=${param.category}">商品子导航(${param.category})</a>
      </div>
  <h1>欢迎来到商城</h1>
  <h2>简介</h2>
  <div class="category-list">
      <p>
Welcome to BookShop</p>
      </div>      <div class="product-filter">
    <div class="display"><b>显示方式：</b> </div>
  </div>
  <div class="product-list">
  	<msg:Message_iteator  iteator='${Search_Info}' shopid="Info">
		  <div>
          <div class="image"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=nagivation_son&son=${param.category}"><img 
src="http://172.16.142.98:8080/ZH_2/${Info.getShop_Image()}" title="${Info.getShop_name()}" 
alt="MacBook" /></a></div>
            <div class="name"><a href="http://172.16.142.98:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${Info.getShop_id()}&category=nagivation_son&son=${param.category}">${Info.getShop_name()}</a></div>
      <div class="description">
	Stop your co-workers in their tracks with the stunning new 30-inch diagonal HP 

LP3065 Flat Panel ..</div>
            <div class="price">
                ${Info.getShop_price()}  <br />
        <span class="price-tax">税： ￥1.00</span>
              </div>
                  <div class="cart">
       <input type="button" class="button"  onclick="add(${Info.getShop_id()})" value="加入购物车"></input>
      </div>
    ...
    <div class="links">
   	<msg:MyCount id="cn">
   			<a href="http://172.16.142.98:8080/ZH_2/Category_control?action=category_son&page_count=${cn.getCount()}">第${cn.getCount()}页</a>
   	</msg:MyCount>
       </div></div>
  </div>
<div id="footer">
