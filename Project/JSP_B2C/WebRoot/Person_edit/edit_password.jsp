...
<script type="text/javascript">
	...
	function add(index)
	{
		...
		var url = "http://172.16.142.46:8080/ZH_2/control?id="+index+"&action=addcar";
		xmlHttp.open("POST", url,true);
			xmlHttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xmlHttp.onreadystatechange=function()
		{
			if(xmlHttp.readyState==4&&xmlHttp.status==200)
			{
					...
					if(num!=null)
					  document.getElementById("notification").innerHTML='<div class="success"><b>'+num+'</b><a method="post" href="http://172.16.142.46:8080/ZH_2/showcar">查看购物车</a></div>'
			}
		}
	...
	function check_pas()
	{
		...
		document.getElementById("notification").innerHTML='<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt="" />请稍候！检查您原密码是否正确</div>'
		window.setTimeout(check_pas1,600)
	
	}
	function check_again()
	{
		var cheackpwd=document.getElementById("newpassword");
		var cheackpwd1=document.getElementById("newpassword1");
		if(cheackpwd.value!=cheackpwd1.value)
		{
			document.getElementById("show1").innerHTML='<img src="http://172.16.142.46:8080/ZH_2/Imge/Re/error.png"></img>'
			
		}else
		{
		document.getElementById("show1").innerHTML='<img src="http://172.16.142.46:8080/ZH_2/Imge/Re/success.png"></img>'
		  flag=true;
		}
	...
	document.getElementById("notification").style.display="none";
		var pass=document.getElementById("oldpassword").value;
		var url="http://172.16.142.46:8080/ZH_2/Update_info?action=check_pass&password="+pass+"&user="+'${user.user}';
		var xmlHttp;
		if(window.XMLHttpRequest)
		{
			xmlHttp=new XMLHttpRequest();
		...
		xmlHttp.onreadystatechange=function()
		{
			if(xmlHttp.readyState==4&&xmlHttp.status==200)
			{
				...
				if(text==0)
				{
					document.getElementById("show").innerHTML='<img src="http://172.16.142.46:8080/ZH_2/Imge/Re/error.png"></img>'
				}
				else
				{
					document.getElementById("show").innerHTML='<img src="http://172.16.142.46:8080/ZH_2/Imge/Re/success.png"></img>'
					 flag1=true;
				}	
			}
...
onkeydown="this.style.color = '#000000';" />
   ...
   <div id="welcome">
        欢迎您,您登录为:<b><a href="http://172.16.142.46:8080/ZH_2/Person_Info.jsp">${user.user}</a>
   <br />
   <a ></a>
    ${user.time_Start}
    </b>
         <b>(</b> <a href="http://172.16.142.46:8080/ZH_2/control?action=out">退出</a> <b>)</b>      </div>
 <div class="links"><a href="http://172.16.142.46:8080/ZH_2/">首页

</a><a href="http://172.16.142.46:8080/ZH_2/register.jsp">注册</a><a href="http://172.16.142.46:8080/ZH_2/showcar">去结账</a>
...
<div id="column-right">
    <div class="box">
  <div class="box-heading">账户</div>
   <div class="box-content">
 	    <ul>
        <li><a href="http://172.16.142.46:8080/ZH_2/Person_Info.jsp">我的账户</a></li>
        <li><a href="http://172.16.142.46:8080/ZH_2/Update_info?user=${user.user}&action=updatepre">编辑账户</a></li>
      <li><a href="http://172.16.142.46:8080/ZH_2/Update_info?user=${user.user}&action=updatepas">更新密码</a></li>
        <li><a href="http://172.16.142.46:8080/ZH_2/Update_info?user=${user.user}&action=updateadd">更新购物地址</a></li>
      <li><a href="http://172.16.142.46:8080/ZH_2/showcar.jsp">我的购物车</a></li>
      </ul>
      </div>
</div>
  </div>
  <div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.46:8080/ZH_2">首页</a>
         &raquo; <a href="http://172.16.142.46:8080/ZH_2/Update_info?user=${user.user}&action=updatepas">我的密码</a>
      </div>
  <h1>我的账户信息</h1>
  <form action="http://172.16.142.46:8080/ZH_2/Update_info?action=updatepas&user=${user.user}" onsubmit="return check_submit();" method="post" >
    <h2>我的详细信息</h2>
    <div class="content">
      <table class="form">
        <tr>
          <td><span class="required">*</span> 旧密码：</td>
          <td><input type="password" id="oldpassword" onblur="check_pas()"/>
            </td>
        ...
        <tr>
          ...
          <td><input type="text" id="newpassword" />
            </td>
        </tr>
         <tr>
          <td><span class="required">*</span> 重新输入：</td>
          <td><input type="text" id="newpassword1" onblur="check_again()"/>
            </td>  
    ...
    <div class="buttons">
      <div class="left"><a href="http://172.16.142.46:8080/ZH_2/Person_Info.jsp" class="button">返回</a></div>
      <div class="right">
