...
<div id="column-right">
  ...
  <div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.46:8080/ZH_2">首页</a>
         &raquo; <a href="http://172.16.142.46:8080/ZH_2/Person_Info.jsp">我的账户</a>
      </div>
  <h1>我的账户信息</h1>
  <form action="http://172.16.142.46:8080/ZH_2/Update_info?action=updatepre&user=${user.user}" method="post" >
    <h2>我的详细信息</h2>
    <div class="content">
      <table class="form">
        <tr>
          <td><span class="required">*</span> 电子邮箱：</td>
          <td><input type="text" name="email" value="${InfoBean.email}" />
            </td>
        </tr>
        <tr>
          <td><span class="required">*</span> 联系电话：</td>
          <td><input type="text" name="telephone" value="${InfoBean.phone}"/>
            </td>
        </tr>
      </table>
    </div>
