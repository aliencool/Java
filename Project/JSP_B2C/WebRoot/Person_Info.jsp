...
<div id="column-right">
  ...
  <div class="box-heading">账户</div>
   <div class="box-content">
 	    <ul>
        <li><a href="http://172.16.142.98:8080/ZH_2/Person_Info.jsp">我的账户</a></li>
       <li><a href="http://172.16.142.98:8080/ZH_2/Update_info?user=${user.user}&action=updatepre">编辑账户</a></li>
      <li><a href="http://172.16.142.98:8080/ZH_2/Update_info?user=${user.user}&action=updatepas">更新密码</a></li>
        <li><a href="http://172.16.142.98:8080/ZH_2/Update_info?user=${user.user}&action=updateadd">更新购物地址</a></li>
      <li><a href="http://172.16.142.98:8080/ZH_2/showcar.jsp">我的购物车</a></li>
      </ul>
      </div>
</div>
  </div>
  <div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.98:8080/ZH_2">首页</a>
         &raquo; <a href="http://172.16.142.98:8080/ZH_2/Person_Info.jsp">我的账户</a>
      </div>
  <h2>我的账户</h2>
  <div class="content">
    <ul>
  ...
  <div class="content">
    <ul>
      <li><a href="http://172.16.142.98:8080/ZH_2/control?action=showcar">我的购物车</a></li>
      <li><a href="http://172.16.142.98/Web/index.php?route=account/download">历史订单</a></li>
    </ul>
  </div>
    <div class="buttons">
    <div class="right"><a href="http://172.16.142.98:8080/ZH_2" class="button">返回</a></div>
  </div>
	</div>
<div id="footer">
    <div class="column">
