...
<script type="text/javascript">
	...
	function deleteCar(id)
	{
		...
		var url = "http://172.16.142.46:8080/ZH_2/control?id="+id+"&action=delete";
	...
	function update(id,num)
	{
		...
		var url = "http://172.16.142.46:8080/ZH_2/control?id="+id+"&num="+num+"&action=updatecar";
		if(window.XMLHttpRequest)
		{
			xmlHttp=new XMLHttpRequest();
		}
	...
	function updatetoal()
	{
		...
		var url= "http://172.16.142.46:8080/ZH_2/control?action=first";
		if(window.XMLHttpRequest)
		{
			xmlHttp=new XMLHttpRequest();
		}
...
<div id="header">
   <div id="logo"><a href="http://172.16.142.46:8080/ZH_2"><img src="http://172.16.142.46:8080/ZH_2/Imge/Re/251110294145.png" title="Your Store" alt="Store" /></a></div>
        <div id="cart">
  ...
  <div class="content">
      ...
      <table>
                <tr>
          <td class="image">            <a href="http://172.16.142.46/Web/index.php?route=product/product&amp;product_id=47"><img src="http://172.16.142.46/Web/image/cache/data/hp_1-47x47.jpg" alt="HP LP3065" title="HP LP3065" /></a>
            </td>
          <td class="name"><a href="http://172.16.142.46/Web/index.php?route=product/product&amp;product_id=47">HP LP3065</a></td>
          <td class="quantity">x&nbsp;1</td>
          <td class="total">￥100.00</td>
          <td class="remove"><img src="http://172.16.142.46:8080/ZH_2/Imge/Re/error.png" alt="移除" title="移除" onclick="(getURLVar('route') == 'checkout/cart' || getURLVar('route') == 'checkout/checkout') ? location = 'index.php?route=checkout/cart&remove=47:YToxOntpOjIyNTtzOjEwOiIyMDExLTA0LTIyIjt9' : $('#cart').load('index.php?route=module/cart&remove=47:YToxOntpOjIyNTtzOjEwOiIyMDExLTA0LTIyIjt9' + ' #cart > *');" /></td>
        </tr>
                      </table>
    </div>
    ...
    <div class="checkout"><a href="http://172.16.142.46/Web/index.php?route=checkout/cart">查看购物车</a> | <a href="http://172.16.142.46/Web/index.php?route=checkout/checkout">结算</a></div>
      </div>
</div>  <div id="search">
...
<div id="menu">
  ...
  <c:choose>
  	...
  	<form action="http://172.16.142.46/Web/index.php?route=checkout/cart" method="post" enctype="multipart/form-data">
        ...
        <thead>
          <tr>
            ...
            <tbody id='${car.getShopBean().getShop_id()}'>
                <tr>
            <td class="image"><a href="http://172.16.142.46:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${car.getShopBean().getShop_id()}"><img src="http://172.16.142.46:8080/ZH_2/${car.getShopBean().getShop_Image()}" alt="${car.getShopBean().getShop_name()}" title="${car.getShopBean().getShop_name()}" /></a>
              </td>
            <td class="name"><a href="http://172.16.142.46:8080/ZH_2/ShopInfo_Control?action=shopinfolist&shopid=${car.getShopBean().getShop_id()}">${car.getShopBean().getShop_name()}</a>
              </td>
            ...
            <td class="quantity"><input type="text" id='quantity_change${car.getShopBean().getShop_id()}' onblur="update(${car.getShopBean().getShop_id()},this.value)" size="1" value='${car.getCount()}'/>
              ...
              <img src="http://172.16.142.46:8080/ZH_2/Imge/Re/error.png" alt="移除" title="移除" /></a></td>
  ...
  <div class="buttons">
    <div class="right"><a href="http://172.16.142.46:8080/ZH_2/showcar.jsp" class="button">去结账</a></div>
    <div class="center"><a href= "http://172.16.142.46:8080/ZH_2/control?action=back" class="button">继续购物</a></div>
  </div>
  	</c:when>
  	<c:otherwise>
<div id="content">  <div class="breadcrumb">
        <a href="http://172.16.142.46:8080/ZH_2">首页</a>
         &raquo; <a href="http://172.16.142.46:8080/ZH_2/control?action=showcar">购物车内的商品</a>
      </div>
  <h1>购物车内的商品</h1>
  <div class="content">您的购物车内没有商品！</div>
  <div class="buttons">
    <div class="right"><a href="http://172.16.142.46:8080/ZH_2" class="button">继续</a></div>
  </div>
  </div>
  	</c:otherwise>
  </c:choose>
