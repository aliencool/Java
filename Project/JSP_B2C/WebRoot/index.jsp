...
<div id="menu">
  ...
  <div id="welcome">
        欢迎光临，您可以<a href="http://172.16.142.98:8080/ZH_2/index.jsp">登录</a> 或 <a href="http://172.16.142.98:8080/ZH_2/register.jsp">注册一个帐户</a>。      </div>
  ...
  <div class="login-content">
    <div class="left">
      ...
      <div class="content">
        ...
        <a href="http://172.16.142.98:8080/ZH_2/register.jsp" class="button">继续</a></div>
    </div>
    <div class="right">
      <h2>会员登录</h2>
      <form action="http://172.16.142.98:8080/ZH_2/control" method="post">
        <div class="content">
          <p>如果您已经是本站会员，请直接登录。</p>
          <b>用户名：</b><br />
