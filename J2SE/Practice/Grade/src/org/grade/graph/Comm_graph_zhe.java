...
public class Comm_graph_zhe extends ActionSupport{
	...
	public  JFreeChart getChart() {   
	    ...
	    public JFreeChart  show_column()
		{
				...
				for (int i = 1; i <Get_Excel_command.getIntRow(); i++) {
					...
					System.out.println(Save_command.getNew_Sort()[i][3]);
					categoryDataset.addValue(Save_command.getNew_Sort()[i][3], "判别", i+"行");
					
				}
				JFreeChart jFreeChart= ChartFactory.createLineChart3D("逐步判别", "分类:1-2-3", "数值", categoryDataset,  PlotOrientation.VERTICAL, true, false, false);
