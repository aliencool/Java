...
<div id="wrapper">
  ...
  <div id="page">
		<div id="content">
			<h2>新闻标题:${news.title}                     时间:${news.issue_time}                          消息源:${news.source}</h2>
			<p><img src="http://172.16.142.98:8080/Struts2_Hibernate/${news.imag_url}" width="750" height="250" alt="" /></p>
			<p>${news.content}</p>
			</div>
			...
			<div id="tbox1">
				...
				<ul class="style2">
					...
					<li>
						...
						<p><a href="show.action?id=${news.id}">${fn:substring(news.content,0,10)}........</a></p>
						                                                            -------------时间:${news.issue_time}       
